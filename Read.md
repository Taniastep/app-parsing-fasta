...
- При переноске программы на другое устройство обязательно скорректируйте пути к файлам в коде согласно вашей рабочей среде.
- Регулярно обновляйте версию используемых библиотек (особенно Pandas), чтобы избежать возможных проблем совместимости и безопасности.
